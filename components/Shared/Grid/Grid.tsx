...
const Grid: React.FC<Props> = ({
  ...
  return (
    <div className="w-full h-[calc(100vh-118px)] bg-white-main border-[1px] rounded-[8px] shadow-secondary">
      {/* table heading here */}
      <div className="w-full h-[60px] flex items-center justify-between border-b-[2px] p-4">
        ...
        <div className="w-[300px] flex items-center justify-center">
          <input
            value={Search}
            onChange={SetSearch}
            className="w-[calc(100%-40px)] h-[40px] font-primary font-medium bg-white-main/60 text-black-main/50 text-[14px] focus:outline-none rounded-l-[5px] p-2 border-[1px] focus:border-brand-main placeholder:font-primary"
            type="text"
            placeholder="Search here..."
          />
          <button className="h-[40px] w-[40px] flex items-center justify-center rounded-r-[5px] text-white-main bg-brand-main border-[3px] border-brand-main">
            <BiSearch size={20} />
          </button>
        </div>
      </div>
      <div className="w-full h-[calc(100%-120px)] HideScroll">
        {/* table columns here */}
